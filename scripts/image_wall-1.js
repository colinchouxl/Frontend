(function($){
    ...
    $("#container").on("click "+downEvent,".item .share-icon a",function(event){
        ...
        var share_url = window.parent.location.origin ? window.parent.location.origin : "http://m.okay.do";
            ...
            post.publish(function(data){
                ...
                if(feedback.status == "ok"){
                    ...
                    if(feedback.hash){
                        ...
                        if(!$(share_comp).hasClass("wechat") && new_win){
